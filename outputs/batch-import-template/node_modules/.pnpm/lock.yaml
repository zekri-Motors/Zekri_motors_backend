...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.48.tgz':
    resolution: {integrity: sha512-fw0U2d7Clq1tn4/ioc+KVztF/MEf1lzuEN5GGFXtRJlG8/7e3+WV8ZBzMfBwaWoU/+vatclQLd2vci3W3wsazA==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.48.tgz}
    version: 2.8.48
    hasBin: true
    bundledDependencies:
      - '@oai/walnut'
